...
public class SettingsLayout extends AbstractLayout{

    public SettingsLayout(Stage stage, AnchorPane baseLayout, URLProfiles profiles, UserInfo userInfo, Launcher launcher) {
